...
class Dr_acc:
    ...
    def __init__(self,root):
        ...
        self.root.title("Doctor settings")
...
#         First Image
        ...
        title_lbl=Label(bg_img,text="Doctor Account" , font=("times new roman",35,"bold"),bg="black",fg="white")
        ...
        Left_frame=LabelFrame(bg_img,bd=2,relief=RIDGE,text="Doctor Details", font=("times new roman",12,"bold"))
        ...
        self.left_inside_frame=Frame(Left_frame,relief=RIDGE,bd=2,bg="white")
        self.left_inside_frame.place(x=0,y=135,width=720,height=370)

        #id
        drId_label=Label(self.left_inside_frame,text="DoctorId:",font=("times new roman",12,"bold"),bg="white")
        drId_label.grid(row=0,column = 0,padx=10,pady=5, sticky=W)
        
        drId_entry=ttk.Entry(self.left_inside_frame,width=20,textvariable=self.var_dr_id,font=("times new roman", 13, "bold"))
        drId_entry.grid(row=0,column=1,padx=10,pady=5, sticky=W)
        
        
         # name 
        drnameLabel=Label(self.left_inside_frame,text="Name:",bg="white",font="comicsansns 11 bold")
        drnameLabel.grid(row=1,column=0)

        drname_entry=ttk.Entry(self.left_inside_frame,width=22,textvariable=self.var_dr_nm,font="comicsansns 11 bold")
        drname_entry.grid(row=1,column=1,pady=8)
        
        
         # email
        emlLabel=Label(self.left_inside_frame,text="Email:",bg="white",font="comicsansns 11 bold")
        emlLabel.grid(row=2,column=0)

        eml_entry=ttk.Entry(self.left_inside_frame,width=22,textvariable=self.var_emle,font="comicsansns 11 bold")
        eml_entry.grid(row=2,column=1,pady=8)



        # Old pass 
        old_pass_Label=Label(self.left_inside_frame,text="Old Password:",bg="white",font="comicsansns 11 bold")
        old_pass_Label.grid(row=0,column=2,padx=4,pady=8)


        oldpass_entry=ttk.Entry(self.left_inside_frame,width=22,textvariable=self.var_old_pass,font="comicsansns 11 bold")
        oldpass_entry.grid(row=0,column=3,pady=8)
       
       
        # new pass
        nw_pass_label=Label(self.left_inside_frame,text="New Password:",bg="white",font="comicsansns 11 bold")
        nw_pass_label.grid(row=1,column=2)

        nw_pass_entry=ttk.Entry(self.left_inside_frame,width=22,textvariable=self.var_nw_pass,font="comicsansns 11 bold")
        nw_pass_entry.grid(row=1,column=3,pady=8)
        
        
         # conf pass
        cnf_pass_Label=Label(self.left_inside_frame,text="Confirm Password:",bg="white",font="comicsansns 11 bold")
        cnf_pass_Label.grid(row=2,column=2)

        cnf_pass_entry=ttk.Entry(self.left_inside_frame,width=22,textvariable=self.var_cnf_pass,font="comicsansns 11 bold")
    ...
    #buttons frame
        btn_frame=Frame(self.left_inside_frame,bd=2,relief=RIDGE,bg="white")
        ...
        delete_btn=Button(btn_frame,text="Delete",width=23,font=("times new roman", 13 , "bold"),bg="black",fg="white",command = self.dr_delete)
...
#     def dr_update(self) :
    ...
    def dr_delete(self) :  
        ...
        query = dr_ref.where('id', '==', self.var_dr_id.get())
        documents = query.stream()
        for doc in documents:
            if doc.to_dict().get('password') ==  self.var_old_pass.get() and doc.to_dict().get('id') ==  self.var_dr_id.get():
                    doc.reference.delete() 
                    
                    lbl3=Label(self.left_inside_frame , text="Doctor deleted" ,font=("times new roman",13,"bold"), bg = "white") 
                    lbl3.grid(row=4,column = 3, padx=2, pady=10, sticky=W)    
